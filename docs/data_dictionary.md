...
| `market_bars_daily` | Source-specific daily market OHLCV bars. | Unique instrument/trade date/source/price basis. Links raw payload; includes authoritative price basis and finality. | Indefinite. |
